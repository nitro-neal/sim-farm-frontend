...
const Home= () => {
  ...
  useEffect(() => {   
    ...
    clouds.to("#cloud4", { x: -700, y: 25 }, 0)
        ...
        farms.to("#farm1", { x: 500 }, 0)
        farms.to("#farm2", { x: 1000 }, 0)
        farms.to("#farm3", { x: -1000 }, 0)
        farms.to("#farm4", { x: -700, y: 25 }, 0)
...
fsEnter.addEventListener('click', function (e) {
    ...
    return (
        ...
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 750 500" preserveAspectRatio="xMidYMax slice">
          ...
          <div id = "farms">
            <h1 id="farm1" style={{zIndex:"-1"}}>FARM 1</h1>
            <h1 id="farm2" style={{zIndex:"10"}}>FARM 2</h1>
            <h1 id="farm3">FARM 3</h1>
            <h1 id="farm4">FARM 4</h1>
          </div>
          {/* SCENE 2 */}
          <g id="scene2">
          ...
          <g id="scene1">
            <g id="hills1">
              ...
              <path id="bird" style={{opacity: 0}} > <h1>IN PATH</h1> </path>
        ...
        <a href="https://codepen.io/collection/DxkYzq" target="_blank" className="btn btn_works">My Works</a>
        <button className="btn" id="fullscr">Go Fullscreen</button>
        <h1>SCENE 1</h1>

        <h1 style = {{paddingTop:"70%"}}>SCENE 2</h1>
      </div>
    )
}
